...
public class AdMobPluginAndroid : MonoBehaviour {

    // Defines string values for supported ad sizes.
    public class AndroidAdSize
    {
        private string adSize;
		private AndroidAdSize(string value)
        {
            this.adSize = value;
        }
		...
		public static AndroidAdSize Banner = new AndroidAdSize("BANNER");
		public static AndroidAdSize MediumRectangle = new AndroidAdSize("IAB_MRECT");
		public static AndroidAdSize IABBanner = new AndroidAdSize("IAB_BANNER");
		public static AndroidAdSize Leaderboard = new AndroidAdSize("IAB_LEADERBOARD");
		public static AndroidAdSize SmartBanner = new AndroidAdSize("SMART_BANNER");
    }
	...
	public static void CreateBannerView(string publisherId, AndroidAdSize adSize, bool positionAtTop)
    {
